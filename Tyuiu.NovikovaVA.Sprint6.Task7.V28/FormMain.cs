...
namespace Tyuiu.NovikovaVA.Sprint6.Task7.V28
{
    public partial class FormMain : Form
    {
        ...
        {
            InitializeComponent();
            openFileDialogTask_NVA.Filter = "Значения, разделённые запятыми(*.csv)|*.csv|Все файлы(*.*)|*.*";
            saveFileDialogMatrix_NVA.Filter = "Значения, разделенные запятыми(*.csv)|*.csv|Все файлы(*.*)|*.*"; ;
        }
        static int rows;
        static int colums;
